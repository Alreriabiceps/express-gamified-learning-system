...
const getTestResultsForStudent = async (req, res) => {
  try {
    ...
    const weekScheduleId = req.query.weekScheduleId;
    ...
    // Build query - if weekScheduleId is provided, filter by it
    let query = { studentId: studentId };
    if (weekScheduleId) {
      query.weekScheduleId = weekScheduleId;
    }

    console.log("getTestResultsForStudent query:", query);
